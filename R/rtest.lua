...
R = require "rclient" -- 1.0beta2
 
r = R.connect() -- Connect to a local R session.
...
vb = r.v -- Retrieve v from the r session.
...
map = R.tomap(r.l) -- Indexing via ids instead of numbers.
print(map.a[1], map.b[1], map.c[1]) --> 3, 5, 7
arr2d = R.to2darray(r.m) -- Array of array.
