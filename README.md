...
tar xfva ngx_openresty-1.7.2.1rc2.tar.gz
cd ngx_openresty-1.7.2.1rc2
wget https://github.com/irr/nginx_tcp_proxy_module/raw/master/tcp-ngx-1.7.2.1-rc2.patch
patch -p1 < tcp-ngx-1.7.2.1-rc2.patch
